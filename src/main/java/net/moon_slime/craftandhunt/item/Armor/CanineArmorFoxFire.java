...
public class CanineArmorFoxFire extends ArmorItem {

    private static final CreativeModeTab LEATHERS = ModCreativeModTab.CRAFT_AND_HUNT_ARMORS;



    public CanineArmorFoxFire(EquipmentSlot slot, Properties properties) {
    ...
    public static class Helmet extends CanineArmorFoxFire {
        public Helmet() {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "craftandhunt:textures/models/armor/canine_fox_fire_layer_1.png";
        }
    }

    public static class Chestplate extends CanineArmorFoxFire {
        public Chestplate() {
    ...
    public static class Leggings extends CanineArmorFoxFire {
        public Leggings() {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "craftandhunt:textures/models/armor/canine_fox_fire_layer_2.png";
        }
    }

    public static class Boots extends CanineArmorFoxFire {
        public Boots() {
