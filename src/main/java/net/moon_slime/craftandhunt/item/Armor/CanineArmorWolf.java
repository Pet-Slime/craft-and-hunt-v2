...
public class CanineArmorWolf extends ArmorItem {

    private static final CreativeModeTab LEATHERS = ModCreativeModTab.CRAFT_AND_HUNT_ARMORS;



    public CanineArmorWolf(EquipmentSlot slot, Properties properties) {
    ...
    public static class Helmet extends CanineArmorWolf {
        public Helmet() {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "craftandhunt:textures/models/armor/canine_wolf_layer_1.png";
        }
    }

    public static class Chestplate extends CanineArmorWolf {
        public Chestplate() {
    ...
    public static class Leggings extends CanineArmorWolf {
        public Leggings() {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "craftandhunt:textures/models/armor/canine_wolf_layer_2.png";
        }
    }

    public static class Boots extends CanineArmorWolf {
        public Boots() {
